...
/**
 * Esta classe é responsável por fazer a ação de intersecção de dois arquivos 
 *   <code>.cm</code> selecionados na árvore de aquivos do package explorer.
 *   
	...
	public void run(IAction action) {
		...
		if (CM_PATH.isEmpty()) {
			CmFilesOperations.showMessage("Do Intersection Action",
					"You must set the path to .cm files on the TaBuLeTa preference page.");
			return;
		}		
		String[] files = null;
