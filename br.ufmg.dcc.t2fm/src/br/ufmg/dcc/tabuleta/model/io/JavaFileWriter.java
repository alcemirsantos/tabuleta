...
/**
 * Esta classe é responsável por escrever a suíte de testes gerada na classe 
 *   {@link GenerateTestSuiteAction}. 
...
public class JavaFileWriter {
	 ...
	 * @param model
	 */
	public JavaFileWriter(String dirName, String packageName, String className,
			ConcernModel model) {
	...
	public File write(ISelection iSelection) {
		...
		try {
			...
			out.println();
			out.println(getImportsClassesFromModel(iSelection));
			out.println();
			comment = "/** \n"
	 ...
	 * @return
	 */
	private String getImportsClassesFromModel(ISelection iSelection) {
		String imports = "";
		IStructuredSelection lStructuredSelection = null;
		if (iSelection instanceof IStructuredSelection) {
			lStructuredSelection = (IStructuredSelection) iSelection;
		...
		for (Object object : objects) {
			if (object instanceof JavaElementNode) {
				JavaElementNode jen = (JavaElementNode) object;
				imports += "import " + getPackage(jen)
						+ jen.getElement().getElementName() + ";\n";
	...
	/**
	 * Build a string representing the package needed to import a class
	 * used in the Test Suite.
	 * @param jen
	 * @return a String looking like a package
	 */
