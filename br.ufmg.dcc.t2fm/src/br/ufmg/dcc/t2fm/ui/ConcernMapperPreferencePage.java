...
/**
 * Implements the preference page for Test2FeatureMapper.
 */
public class ConcernMapperPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
	...
	/**
	 * Creates a new preference page for Test2FeatureMapper.
	 */
	public ConcernMapperPreferencePage() 
	{
		super( FieldEditorPreferencePage.GRID );
		IPreferenceStore lStore = Test2FeatureMapper.getDefault().getPreferenceStore();
	...
	public void createFieldEditors()
	{
		...
		addField( new LabelFieldEditor( 
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.HeaderFilter" ), getFieldEditorParent() ) );
		addField( new BooleanFieldEditor(P_FILTER_ENABLED,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.FilterEnabled" ),
				getFieldEditorParent()) );
		IntegerFieldEditor lIntegerFieldEditor = new IntegerFieldEditor(P_FILTER_THRESHOLD,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.FilterThreshold" ),
				getFieldEditorParent());
		...
		//Saving
		addField( new LabelFieldEditor( 
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.HeaderSaving" ), getFieldEditorParent() ) );
		addField( new BooleanFieldEditor( P_CM_FILE_EXT,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.CmFileExt" ),
				getFieldEditorParent() ) );
		addField( new BooleanFieldEditor( P_AUTO_SAVE,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.AutoSave" ),
				getFieldEditorParent() ) );
		addField( new BooleanFieldEditor( P_AUTO_LOAD,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.AutoLoad" ),
				getFieldEditorParent() ) );
		addField( new LabelFieldEditor( "", getFieldEditorParent() ) );
		
		//UI
		addField( new LabelFieldEditor( 
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.HeaderUI" ), getFieldEditorParent() ) );
		
		addField( new BooleanFieldEditor(ConcernMapperPreferencePage.P_SHOW_SLIDER,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.ShowSlider" ),
				getFieldEditorParent()) );
		addField( new BooleanFieldEditor(ConcernMapperPreferencePage.P_SHOW_COMMENTS,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.ShowComments" ),
				getFieldEditorParent()) );
		addField( new BooleanFieldEditor(ConcernMapperPreferencePage.P_SUFFIX_ENABLED,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.SuffixEnabled" ),
				getFieldEditorParent()) );
		addField( new BooleanFieldEditor(ConcernMapperPreferencePage.P_BOLD_ENABLED,
				Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.BoldEnabled" ),
				getFieldEditorParent()) );
		
		String[][] lRadioGroupValues = {
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent1" ), "1"},
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent2" ), "2"},
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent3" ), "3"},
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent4" ), "4"},
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent5" ), "5"},
				{Test2FeatureMapper.getResourceString( "ui.ConcernMapperPreferencePage.Parent6" ), "7"}};
		addField( new RadioGroupFieldEditor(
				ConcernMapperPreferencePage.P_DECORATION_LIMIT, Test2FeatureMapper.
