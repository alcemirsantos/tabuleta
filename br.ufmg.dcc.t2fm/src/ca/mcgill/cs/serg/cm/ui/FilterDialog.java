...
public class FilterDialog extends MessageDialogWithToggle 
{
	...
	{
		super( pParentShell, 
			   ConcernMapper.getResourceString( "views.ConcernMapperView.FilterDialogTitle" ), 
			   null, 
			   ...
			   ConcernMapper.getDefault().getPreferenceStore().getBoolean( ConcernMapperPreferencePage.P_FILTER_ENABLED ));
	}
	...
	protected Control createCustomArea( Composite pParent )
	{
		...
		aThresholdSlider.setSelection(
				ConcernMapper.getDefault().getPreferenceStore().getInt(
